...
export declare function launch3DProteinView({ session, view, feature, selectedTranscript, uniprotId, url, data, userProvidedTranscriptSequence, alignmentAlgorithm, displayName, sideBySide, }: LaunchViewParams & Launch3DExtraParams & {
    sideBySide?: boolean;
