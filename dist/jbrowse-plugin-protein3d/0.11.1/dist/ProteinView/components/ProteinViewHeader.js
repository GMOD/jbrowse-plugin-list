...
const ProteinViewHeader = observer(function ProteinViewHeader({ model, }) {
    ...
    return (React.createElement("div", null,
        ...
        showAlignment
            ? structures
                .filter(s => s.pairwiseAlignment || s.alignmentPending || s.alignmentSkipped)
                .map((structure, idx) => (React.createElement("div", { key: idx }, structure.pairwiseAlignment ? (React.createElement(ProteinAlignment, { model: structure })) : structure.alignmentSkipped ? (React.createElement(Typography, { variant: "caption", color: "error" }, structure.alignmentSkipped)) : (React.createElement(LoadingEllipses, { message: "Loading pairwise alignment" })))))
            : null,
