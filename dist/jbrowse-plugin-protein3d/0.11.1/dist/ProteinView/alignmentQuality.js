import { alignmentLength, structureAlignedSeq, transcriptAlignedSeq, } from '../mappings';
/**
...
export function alignmentQuality(pa) {
...
export function isLowSimilarity(q) {
    const floor = q.identical < SHORT_ALIGNMENT_RESIDUES
 ...
 * structure residues". */
export function describeAlignmentQuality(q) {
    if (q.aligned === 0) {
