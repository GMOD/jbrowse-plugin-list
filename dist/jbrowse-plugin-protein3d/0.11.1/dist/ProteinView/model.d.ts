...
import { type PersistedSetting } from './storedSettings';
...
declare function stateModelFactory(): import("@jbrowse/mobx-state-tree").IModelType<Omit<{
...
}, "id" | "type" | "colorScheme" | "height" | "structures" | "showControls" | "showAlignment" | "showHighlight" | "showProteinTracks" | "compactTracks" | "zoomToBaseLevel" | "autoScrollAlignment" | "alignmentAlgorithm"> & {
    id: import("@jbrowse/mobx-state-tree").IOptionalIType<import("@jbrowse/mobx-state-tree").ISimpleType<string>, [undefined]>;
    ...
    structures: import("@jbrowse/mobx-state-tree").IArrayType<import("@jbrowse/mobx-state-tree").IModelType<{
        ...
        structureConfidence: import("./extractPerResidueConfidence").EntityConfidence[] | undefined;
        ...
        uniProtMappings: import("./pdbUniProtMapping").UniProtStructureMapping[] | undefined;
        uniProtMappingsError: unknown;
    } & {
        setUniProtMappings(mappings?: import("./pdbUniProtMapping").UniProtStructureMapping[], error?: unknown): void;
        ...
        setAlignment(r?: import("../mappings").PairwiseAlignment, imported?: any): void;
        ...
        readonly alignment: import("../mappings").PairwiseAlignment | undefined;
        ...
        interactionPosition(info: import("./subscribeMolstarInteraction").MolstarLocationInfo): number | undefined;
     ...
     */
    toggleSetting(key: PersistedSetting): void;
} & {
    afterAttach(): void;
} & {
    ...
    readonly displayToggles: {
        label: "Show alignment" | "Show feature tracks" | "Compact tracks" | "Auto-scroll alignment to hovered position";
        checked: boolean;
        toggle: () => void;
    }[];
} & {
