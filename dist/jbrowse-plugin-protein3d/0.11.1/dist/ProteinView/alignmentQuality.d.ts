 ...
 */
export declare const LOW_IDENTITY_OVER_SHORTER = 0.3;
export declare const SHORT_ALIGNMENT_RESIDUES = 20;
export declare const SHORT_ALIGNMENT_IDENTITY = 0.8;
export declare const MIN_IDENTICAL_RESIDUES = 5;
export declare function alignmentQuality(pa: PairwiseAlignment): AlignmentQuality;
export declare function isLowSimilarity(q: AlignmentQuality): boolean;
/** One line for the alignment header: "87% identity over 219 of 393
 * structure residues". */
export declare function describeAlignmentQuality(q: AlignmentQuality): string;
