...
import { chooseUniProtMappingForEntity, identityUniProtPositionMap, makeUniProtPositionMap, } from '../pdbUniProtMapping';
/**
 ...
 */
export default function useStructureUniProt({ uniprotId: alphaFoldUniprotId, pdbId, uniProtMappings, uniProtMappingsError, mappedEntity, }) {
    ...
    const siftsMapping = useMemo(() => uniProtMappings
        ? chooseUniProtMappingForEntity(uniProtMappings, mappedEntity)
        : undefined, [uniProtMappings, mappedEntity]);
