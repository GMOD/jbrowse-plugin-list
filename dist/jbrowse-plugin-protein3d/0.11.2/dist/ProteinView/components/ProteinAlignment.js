...
import { LOW_IDENTITY_OVER_SHORTER, SHORT_ALIGNMENT_IDENTITY, SHORT_ALIGNMENT_RESIDUES, describeAlignmentQuality, isLowSimilarity, } from '../alignmentQuality';
...
const ProteinAlignment = observer(function ProteinAlignment({ model, }) {
    ...
    const { uniprotId, uniprotName, mapUniProtPosition, isLoading: uniprotLoading, error: uniprotError, } = useStructureUniProt({
    ...
    return (React.createElement("div", { "data-testid": "protein-alignment-panel", "data-structure": label },
        ...
        React.createElement("div", { style: {
            ...
            React.createElement("div", { ref: containerRef, className: classes.scroll },
                ...
                React.createElement(AlignmentRuler, { model: model, columns: a0.length }),
