...
export async function applyColorTheme({ plugin, colorScheme, }) {
    ...
    for (const structure of structures) {
        ...
        await plugin.managers.structure.component.updateRepresentationsTheme(structure.components, { color: colorScheme });
    }
}
