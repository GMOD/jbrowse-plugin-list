...
const ProteinAlignment = observer(function ProteinAlignment({ model, }) {
    const { pairwiseAlignment, showHighlight, showProteinTracks, url, confidenceCells, hydrophobicityCells, } = model;
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { float: 'right', display: 'flex', alignItems: 'center' } },
        ...
        React.createElement("div", { style: {
            ...
            React.createElement("div", { style: {
                ...
                React.createElement(GutterLabel, { label: "residue", title: "Structure residue number, as the 3D view counts them", height: ROW_HEIGHT }),
