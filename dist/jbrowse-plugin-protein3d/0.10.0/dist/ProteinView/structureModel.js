...
const Structure = types
    ...
    afterAttach() {
        ...
        addDisposer(self, autorun(() => {
            try {
                const { userProvidedTranscriptSequence, structureSequences, alignmentAlgorithm, } = self;
                ...
                const selection = chooseMappedEntity(userProvidedTranscriptSequence, structureSequences, alignmentAlgorithm);
                if (!selection) {
                    return;
                }
