...
import { PERSISTED_SETTINGS, readStoredSettings, withStoredSettings, writeStoredSettings, } from './storedSettings';
...
import { ALIGNMENT_ALGORITHM_VALUES, DEFAULT_ALIGNMENT_ALGORITHM, } from './types';
/**
...
function stateModelFactory() {
    return types
        ...
        .preProcessSnapshot((snapshot) => withStoredSettings(snapshot, readStoredSettings()))
        .volatile(() => ({
        /**
         * #volatile
         */
        ...
        afterAttach() {
            ...
            addDisposer(self, reaction(() => PERSISTED_SETTINGS.map(key => self[key]), () => {
                const settings = {};
