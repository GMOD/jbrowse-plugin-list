...
export declare const COMPACT_TRACK_HEIGHT = 8;
export declare const COMPACT_TRACK_GAP = 1;
export declare const NORMAL_TRACK_HEIGHT = 12;
export declare const NORMAL_TRACK_GAP = 2;
