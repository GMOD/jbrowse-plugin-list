...
const ProteinAlignment = observer(function ProteinAlignment({ model, }) {
    const { pairwiseAlignment, showHighlight, showProteinTracks, url, label, confidenceCells, hydrophobicityCells, } = model;
    ...
    return (React.createElement("div", { "data-testid": "protein-alignment-panel", "data-structure": label },
        React.createElement("div", { style: {
            ...
            React.createElement(Typography, { variant: "subtitle2" },
                label,
                showHighlight ? (React.createElement(Typography, { variant: "caption", color: "textSecondary", sx: { ml: 1 } }, "green is the aligned portion")) : null),
