...
export default function LaunchProteinViewExtensionPointF(pluginManager) {
    ...
    // @ts-expect-error
    async (args) => {
        const { session, url, uniprotId, pdbId, transcriptId, userProvidedTranscriptSequence, feature, connectedViewId, connectedView, alignmentAlgorithm, displayName, height, showControls, showHighlight, zoomToBaseLevel, sideBySide, initialSelection, initialResidues, } = args;
