...
import { extractFeatureIdentifiers, getDatabaseTypeForId, getUniProtIdFromFeature, isRecognizedDatabaseId, } from './util';
...
describe('extractFeatureIdentifiers', () => {
    ...
    test('deduplicates IDs when same ID appears in multiple attributes', () => {
        ...
        const nmCount = result.recognizedIds.filter(id => id === 'NM_001310462').length;
