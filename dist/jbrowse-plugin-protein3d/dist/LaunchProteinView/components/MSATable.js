...
export default function MSATable({ structureName, structureSequence, isoformSequences, }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Checkbox2, { onChange: event => {
                setShowInFastaFormat(event.target.checked);
            }, label: "Show in FASTA format?", checked: showInFastaFormat }),
        React.createElement(TextField, { variant: "outlined", multiline: true, minRows: 5, maxRows: 10, fullWidth: true, value: showInFastaFormat
                ? [
                    `>${sname}\n${structureSequence}`,
