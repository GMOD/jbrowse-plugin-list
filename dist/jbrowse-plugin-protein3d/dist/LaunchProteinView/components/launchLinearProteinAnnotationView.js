...
export async function launchLinearProteinAnnotationView({ session, uniprotId, feature, selectedTranscript, confidenceUrl, }) {
    try {
        ...
        const trackConfigs = [
            ...new Set((await textfetch(`https://rest.uniprot.org/uniprotkb/${uniprotId}.gff`))
                .split('\n')
...
//# sourceMappingURL=launchLinearProteinAnnotationView.js.map