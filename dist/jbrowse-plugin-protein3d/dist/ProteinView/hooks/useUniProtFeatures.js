...
export default function useUniProtFeatures(uniprotId) {
    const { data, error, isLoading } = useSWR(uniprotId ? `https://rest.uniprot.org/uniprotkb/${uniprotId}.gff` : null, fetchUniProtFeatures);
    return {
        features: data,
        error,
        isLoading,
