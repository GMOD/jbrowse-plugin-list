...
export { createStructureColorThemeParams } from 'molstar/lib/mol-plugin-state/helpers/structure-representation-params'
...
export { StateObjectRef, StateSelection } from 'molstar/lib/mol-state'
