    ...
    useEffect(() => {
        ...
        void (async () => {
            try {
                ...
                const { Color, GeometryExport, MAQualityAssessment, PluginConfig, PluginSpec, DefaultPluginUISpec, createPluginUI, registerColorThemes, renderReact18, css, } = await loadMolstar();
