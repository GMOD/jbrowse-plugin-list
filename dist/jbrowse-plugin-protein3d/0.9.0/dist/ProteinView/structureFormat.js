...
export function structureFileExtension(nameOrUrl) {
...
export function isBinaryStructureUrl(url) {
 ...
 */
export function structureFormatFromContent(data) {
...
export function structureFormatFor({ url, data, }) {
