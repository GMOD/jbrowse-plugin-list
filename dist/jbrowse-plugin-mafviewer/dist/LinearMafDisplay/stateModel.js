    ...
    return types
        ...
        get root() {
            ...
            if (self.subtreeFilter && self.subtreeFilter.length > 0) {
                ...
                const findSubtreeRoot = (node) => {
                    const getLeafNames = (n) => {
                    ...
                    const allMatch = leafNames.length === filterSet.size &&
        ...
        const { rowHeight, rowProportion, showAllLetters, mismatchRendering, showBranchLen, treeAreaWidth, showAsUpperCase, showSidebar, subtreeFilter, ...rest } = snap;
        return {
            ...rest,
