...
var configSchema = /*#__PURE__*/ConfigurationSchema("UCSCAdapter", {
  base: {
    type: "fileLocation",
          ...
          return runtime_1.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _readConfObject = readConfObject(_this2.config, "base"), uri = _readConfObject.uri;
                  track = readConfObject(_this2.config, "track");
                  _context.prev = 2;
                  _context.next = 5;
...
export default UCSCPlugin;
//# sourceMappingURL=jbrowse-plugin-ucsc.esm.js.map
