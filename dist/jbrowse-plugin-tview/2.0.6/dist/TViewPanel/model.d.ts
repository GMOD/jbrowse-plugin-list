...
export default function stateModelFactory(): import("@jbrowse/mobx-state-tree").IModelType<Omit<Omit<{
...
}, "type" | "insertionWidths" | "connectedViewId" | "msaRegion" | "msaSource" | "zoomToBaseLevel"> & {
     ...
     */
    msaSource: import("@jbrowse/mobx-state-tree").IType<MsaSource | undefined, MsaSource | undefined, MsaSource | undefined>;
    /**
     * #property
     */
     ...
     */
    readonly msaSourceConf: (import("@jbrowse/mobx-state-tree").ModelInstanceTypeProps<Record<string, any>> & {
     ...
     * #action
     */
    setRebuilding(arg: boolean): void;
    /**
     * #action
     */
    setRebuildFailed(arg: boolean): void;
    /**
     * #action
     */
    setMsaData(msa: string, insertionWidths: [number, number][]): void;
    /**
     * #action
     */
     ...
     */
    rebuildMsa(conf: AnyConfigurationModel, source: MsaSource): Promise<void>;
} & {
    afterCreate(): void;
} & {
    /**
