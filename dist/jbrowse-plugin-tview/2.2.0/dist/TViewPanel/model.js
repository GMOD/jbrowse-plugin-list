    ...
    return types
        ...
        async load(region, sources) {
            ...
            try {
                ...
                if (result.tooLarge) {
                    throw new Error(`alignment is ${result.cellCount.toLocaleString('en-US')} cells, above the ${MAX_CELLS.toLocaleString('en-US')} limit`);
                }
