...
function arraysOfPeriod(seq, period) {
 ...
 */
export function findReferenceArrays(seq, offset = 0) {
 ...
 */
export function mergeArrays(arrays, gap = 0) {
    const groups = [];
