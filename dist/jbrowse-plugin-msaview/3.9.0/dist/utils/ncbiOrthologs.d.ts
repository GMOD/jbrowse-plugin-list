 ...
 */
export declare function resolveGeneId(candidates: string[], taxId: number, signal?: AbortSignal): Promise<{
    geneId: string;
    matched: string;
} | undefined>;
/**
 ...
 */
export declare function fetchOrthologGenes(geneId: string, { taxa, exclude, limit, signal, }?: {
    taxa?: Set<number>;
    exclude?: number;
    limit?: number;
    signal?: AbortSignal;
 ...
 */
export declare function fetchRepresentativeProteins(geneIds: string[], signal?: AbortSignal): Promise<Map<string, string>>;
 ...
 */
export declare function fetchProteinForGene(geneId: string, signal?: AbortSignal): Promise<{
    accession: string;
    sequence: string;
} | undefined>;
/**
 ...
 */
export declare function fetchOrthologRows({ geneId, taxa, exclude, limit, onProgress, signal, }: {
    geneId: string;
    taxa?: Set<number>;
    exclude?: number;
    limit?: number;
