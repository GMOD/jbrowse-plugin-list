 ...
 */
export declare const STATUS_FAILURE_BUDGET_MS: number;
...
export declare function runEbiJob({ tool, label, params, onProgress, onRid, signal, }: {
    tool: string;
    label: string;
    ...
    jobId: string;
    result: (type: string) => Promise<string>;
}>;
