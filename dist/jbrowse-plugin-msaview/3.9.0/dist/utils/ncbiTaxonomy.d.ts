 ...
 */
export declare function resolveTaxId(query: string, signal?: AbortSignal): Promise<number | undefined>;
/**
 ...
 */
export declare function resolveAssemblySpecies(assemblyName: string, signal?: AbortSignal): Promise<{
    taxId: number;
    speciesName: string;
} | undefined>;
