...
export declare const unirefIdentities: readonly [50, 90];
...
export declare function fetchClusterId(accession: string, identity: UnirefIdentity, signal?: AbortSignal): Promise<{
    id: string;
