...
export declare function mouseEventsModelIntermediateFactory(pluginManager: PluginManager, configSchema: AnyConfigurationSchemaType): import("@jbrowse/mobx-state-tree").IModelType<{
    ...
    getAssemblyId(assemblyName: string): any;
    ...
    getGlyph(_feature: AnnotationFeature): import("../glyphs/Glyph").Glyph;
...
export declare function mouseEventsModelFactory(pluginManager: PluginManager, configSchema: AnyConfigurationSchemaType): import("@jbrowse/mobx-state-tree").IModelType<{
    id: import("@jbrowse/mobx-state-tree").IOptionalIType<import("@jbrowse/mobx-state-tree").ISimpleType<string>, [undefined]>;
    type: import("@jbrowse/mobx-state-tree").ISimpleType<string>;
    rpcDriverName: import("@jbrowse/mobx-state-tree").IMaybe<import("@jbrowse/mobx-state-tree").ISimpleType<string>>;
} & {
...
export type LinearApolloSixFrameDisplayMouseEventsModel = ReturnType<typeof mouseEventsModelIntermediateFactory>;
export interface LinearApolloSixFrameDisplayMouseEvents extends Instance<LinearApolloSixFrameDisplayMouseEventsModel> {
}
