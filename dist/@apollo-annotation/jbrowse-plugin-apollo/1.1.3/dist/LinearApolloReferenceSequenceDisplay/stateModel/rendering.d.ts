...
export declare function renderingModelFactory(pluginManager: PluginManager, configSchema: AnyConfigurationSchemaType): import("@jbrowse/mobx-state-tree").IModelType<{
    ...
    seqTrackCanvas: HTMLCanvasElement | null;
    seqTrackOverlayCanvas: HTMLCanvasElement | null;
    theme: Theme;
} & {
    setSeqTrackCanvas(canvas: HTMLCanvasElement | null): void;
    setSeqTrackOverlayCanvas(canvas: HTMLCanvasElement | null): void;
    setTheme(theme: Theme): void;
    afterAttach(): void;
}, import("@jbrowse/mobx-state-tree")._NotCustomized, import("@jbrowse/mobx-state-tree")._NotCustomized>;
export type LinearApolloReferenceSequenceDisplayRenderingModel = ReturnType<typeof renderingModelFactory>;
export interface LinearApolloReferenceSequenceDisplayRendering extends Instance<LinearApolloReferenceSequenceDisplayRenderingModel> {
}
