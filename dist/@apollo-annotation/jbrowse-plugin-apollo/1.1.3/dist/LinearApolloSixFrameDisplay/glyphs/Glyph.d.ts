...
export interface Glyph {
    ...
    onMouseLeave(display: LinearApolloSixFrameDisplayMouseEvents, currentMousePosition: MousePositionWithFeature, event: CanvasMouseEvent): void;
    onMouseUp(display: LinearApolloSixFrameDisplayMouseEvents, currentMousePosition: MousePositionWithFeature, event: CanvasMouseEvent): void;
    drawTooltip(display: LinearApolloSixFrameDisplayMouseEvents, context: CanvasRenderingContext2D): void;
    getContextMenuItemsForFeature(display: LinearApolloSixFrameDisplayMouseEvents, sourceFeature: AnnotationFeature): MenuItem[];
    getContextMenuItems(display: LinearApolloSixFrameDisplayMouseEvents, currentMousePosition: MousePositionWithFeature): MenuItem[];
}
