...
export type LinearApolloSixFrameDisplayStateModel = ReturnType<typeof stateModelFactory>;
export interface LinearApolloSixFrameDisplay extends Instance<LinearApolloSixFrameDisplayStateModel> {
}
