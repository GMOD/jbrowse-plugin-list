...
var configSchema = /*#__PURE__*/ConfigurationSchema("CIVICAdapter", {
  base: {
    type: "string",
      ...
      var _fetchFeatures = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
        ...
        return runtime_1.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              str = readConfObject(this.config, "base");
              _context.next = 3;
              return fetch(str);
            case 3:
    ...
    value: function configure(pluginManager) {
      autorun(function () {
        ...
        if (root && session) {
          ...
          //@ts-ignore
          var found = resolveIdentifier(trackConfigSchema, root, trackId);
          if (!found) {
            //@ts-ignore
...
export default CIVICPlugin;
//# sourceMappingURL=jbrowseplugincivic.esm.js.map
