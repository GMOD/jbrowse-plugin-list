(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@jbrowse/core/pluggableElementTypes/AdapterType'), require('@jbrowse/core/Plugin'), require('@jbrowse/core/configuration'), require('@jbrowse/core/util/rxjs'), require('@jbrowse/core/data_adapters/BaseAdapter'), require('mobx'), require('mobx-state-tree')) :
  typeof define === 'function' && define.amd ? define(['exports', '@jbrowse/core/pluggableElementTypes/AdapterType', '@jbrowse/core/Plugin', '@jbrowse/core/configuration', '@jbrowse/core/util/rxjs', '@jbrowse/core/data_adapters/BaseAdapter', 'mobx', 'mobx-state-tree'], factory) :
  (global = global || self, factory(global.JBrowsePluginCIVIC = {}, global.JBrowseExports['@jbrowse/core/pluggableElementTypes/AdapterType'], global.JBrowseExports['@jbrowse/core/Plugin'], global.JBrowseExports['@jbrowse/core/configuration'], global.JBrowseExports['@jbrowse/core/util/rxjs'], global.JBrowseExports['@jbrowse/core/data_adapters/BaseAdapter'], global.JBrowseExports.mobx, global.JBrowseExports['mobx-state-tree']));
}(this, (function (exports, AdapterType, Plugin, configuration, rxjs, BaseAdapter, mobx, mobxStateTree) { 'use strict';
  ...
  var _excluded = ["coordinates", "id", "description"];
  var configSchema = /*#__PURE__*/configuration.ConfigurationSchema("CIVICAdapter", {
    base: {
      type: "string",
  ...
  var AdapterClass = /*#__PURE__*/function (_BaseFeatureDataAdapt) {
    ...
    _createClass(AdapterClass, [{
      key: "fetchFeatures",
      value: function () {
        var _fetchFeatures = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
          var str, result;
          return runtime_1.wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                str = configuration.readConfObject(this.config, "base");
                _context.next = 3;
                return fetch(str);
              case 3:
      ...
      key: "formatFeature",
      value: function formatFeature(data) {
        ...
        if (start - 1 < stop) {
          return new SimpleFeature(_objectSpread2(_objectSpread2({}, rest), {}, {
            coordinates: coordinates,
            id: '<a href="https://civicdb.org/variants/' + id + '/summary">CIVIC DB - ' + id + "</a>",
            start: start - 1,
            end: stop,
            refName: chromosome,
            uniqueId: id
              ...
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 3:
                  ...
                  data.records.map(function (r) {
                    return _this.formatFeature(r);
                  }).filter(function (f) {
                    return !!f;
                  }).filter(function (f) {
                    return f.get("refName") === refName && f.get("end") >= start && f.get("start") <= end;
                  }).forEach(function (f) {
                    observer.next(f);
                  });
                  observer.complete();
  ...
  var CIVICPlugin = /*#__PURE__*/function (_Plugin) {
    _inherits(CIVICPlugin, _Plugin);
    var _super = /*#__PURE__*/_createSuper(CIVICPlugin);
    function CIVICPlugin() {
      var _this;
      _classCallCheck(this, CIVICPlugin);
      _this = _super.apply(this, arguments);
      _this.name = "CIVICPlugin";
      _this.version = version;
      return _this;
    }
    _createClass(CIVICPlugin, [{
      key: "install",
      ...
      value: function configure(pluginManager) {
        mobx.autorun(function () {
          var root = pluginManager.rootModel;
          var session = root === null || root === void 0 ? void 0 : root.session;
          if (root && session) {
            ...
            var trackId = "civic_hg19";
            //@ts-ignore
            var found = mobxStateTree.resolveIdentifier(trackConfigSchema, root, trackId);
            if (!found) {
              //@ts-ignore
  ...
  exports.default = CIVICPlugin;

  Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=jbrowseplugincivic.umd.development.js.map
