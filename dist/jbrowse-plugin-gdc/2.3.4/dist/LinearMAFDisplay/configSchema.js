...
const linearMAFDisplayConfigSchema = pluginManager => {
    ...
    return ConfigurationSchema('LinearMAFDisplay', { renderer: pluginManager.pluggableConfigSchemaType('renderer') }, { baseConfiguration: baseLinearDisplayConfigSchema, explicitlyTyped: true });
};
