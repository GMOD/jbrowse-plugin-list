...
describe('GDCTrack widget', () => {
    it('renders mutation extra panel', () => {
        ...
        const { container } = render(React.createElement(ThemeProvider, { theme: createJBrowseTheme() },
            React.createElement(GDCExtraPanel, { feature: feature })));
...
//# sourceMappingURL=GDCFeatureWidget.test.js.map