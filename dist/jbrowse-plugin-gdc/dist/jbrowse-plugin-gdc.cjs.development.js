...
var InternetAccountType = require('@jbrowse/core/pluggableElementTypes/InternetAccountType');
...
var InsertDriveFile = require('@mui/icons-material/InsertDriveFile');
...
var TrackType$1 = require('@jbrowse/core/pluggableElementTypes/TrackType');
...
var stateModel = (function (jbrowse) {
  ...
  return mobxStateTree.types.model('GDCFilterWidget', {
    id: mst.ElementId,
    type: mobxStateTree.types.literal('GDCFilterWidget'),
    target: mobxStateTree.types.safeReference(jbrowse.pluggableConfigSchemaType('track')),
 ...
 */
const FilterList = mobxReact.observer(({ schema, type, facets }) => {
    const initialFilterSelection = facets[0].name;
    const handleClick = () => {
        schema.addFilter(uuid.v4(), initialFilterSelection, type, '');
    };
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(material.Button, { variant: "outlined", onClick: handleClick, startIcon: React.createElement(AddIcon, null) }, "Add Filter")));
});
            ...
            if (filters.content && filters.content.length > 0) {
                for (const filter of filters.content) {
                    ...
                    if (type) {
                        ...
                        schema.addFilter(uuid.v4(), name, type, filter.content.value.join(','));
                    }
                }
            }
        }
...
function stateModelFactory$1(_pluginManager) {
    const stateModel = mobxStateTree.types
        ...
        id: mst.ElementId,
        type: mobxStateTree.types.literal('GDCFeatureWidget'),
        ...
        React.createElement("div", { style: { width: '100%', maxHeight: 600, overflow: 'auto' } },
            React.createElement(material.Table, { className: classes.table },
                ...
                React.createElement(material.TableBody, null, Object.entries(consequences).map(([key, value]) => value ? (React.createElement(material.TableRow, { key: key },
                    ...
                    React.createElement(material.TableCell, null, value.node.transcript.gene.gene_strand === 1 ? (React.createElement(AddIcon, null)) : (React.createElement(RemoveIcon, null))),
                    React.createElement(material.TableCell, null,
...
function f(_pluginManager) {
    return mobxStateTree.types
        ...
        id: mst.ElementId,
        type: mobxStateTree.types.literal('GDCSearchWidget'),
    })
        .volatile(() => ({
        trackData: undefined,
...
const Panel = ({ model }) => {
    ...
    return (React.createElement("div", { className: classes.root },
        React.createElement(material.Paper, { className: classes.paper, elevation: 3 },
            ...
            fileChip ? (React.createElement(material.Chip, { label: fileChip, avatar: React.createElement(InsertDriveFile, null), onDelete: handleDelete })) : null,
        ...
        React.createElement(material.Paper, { className: classes.paper, elevation: 3 },
            ...
            React.createElement("div", { className: classes.addTrackButtonContainer },
                React.createElement(material.Button, { color: "primary", variant: "contained", size: "small", startIcon: React.createElement(AddIcon, null), onClick: () => {
...
var modelF$2 = (pluginManager, configSchema) => {
    ...
    return mobxStateTree.types
        .compose('LinearGDCDisplay', BaseLinearDisplay, mobxStateTree.types.model({
        type: mobxStateTree.types.literal('LinearGDCDisplay'),
...
var modelF$1 = (function (jbrowse) {
  ...
  return mobxStateTree.types.compose('LinearIEQDisplay', BaseLinearDisplay, mobxStateTree.types.model({
    type: mobxStateTree.types.literal('LinearIEQDisplay'),
    configuration: configuration.ConfigurationReference(configSchema)
  })).actions(function (self) {
    return {
...
var modelF = (function (jbrowse) {
  ...
  var BaseLinearDisplay = jbrowse.getPlugin('LinearGenomeViewPlugin').exports.BaseLinearDisplay;
  return mobxStateTree.types.compose('LinearMAFDisplay', BaseLinearDisplay, mobxStateTree.types.model({
...
var GDCAdapterConfigSchema = configuration.ConfigurationSchema('GDCAdapter', {
    ...
    featureType: {
        type: 'stringEnum',
        model: mobxStateTree.types.enumeration('Feature Type', ['mutation', 'gene']),
...
const stateModelFactory = (configSchema) => {
    return mobxStateTree.types
        .compose('GDCInternetAccount', models.InternetAccount, mobxStateTree.types.model({
        id: 'GDCToken',
        type: mobxStateTree.types.literal('GDCInternetAccount'),
        configuration: configuration.ConfigurationReference(configSchema),
    }))
        .volatile(() => ({
        needsToken: false,
...
//# sourceMappingURL=jbrowse-plugin-gdc.cjs.development.js.map
