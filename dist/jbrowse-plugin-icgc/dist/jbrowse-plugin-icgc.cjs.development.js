...
var DisplayType = require('@jbrowse/core/pluggableElementTypes/DisplayType');
var WidgetType = require('@jbrowse/core/pluggableElementTypes/WidgetType');
var TrackType = require('@jbrowse/core/pluggableElementTypes/TrackType');
...
var UndoIcon = require('@material-ui/icons/Undo');
var lab = require('@material-ui/lab');
var BaseAdapter = require('@jbrowse/core/data_adapters/BaseAdapter');
var rxjs = require('@jbrowse/core/util/rxjs');
var AbortablePromiseCache = require('abortable-promise-cache');
var LRU = require('@jbrowse/core/util/QuickLRU');
...
var AbortablePromiseCache__default = /*#__PURE__*/_interopDefaultLegacy(AbortablePromiseCache);
...
function configSchemaFactory(pluginManager) {
  ...
  return configuration.ConfigurationSchema('LinearICGCDisplay', {
    renderer: mobxStateTree.types.optional(pluginManager.pluggableConfigSchemaType('renderer'), {
...
function stateModelFactory$1(configSchema, pluginManager) {
  ...
  return mobxStateTree.types.compose('LinearICGCDisplay', BaseLinearDisplay, mobxStateTree.types.model({
    type: mobxStateTree.types.literal('LinearICGCDisplay'),
    configuration: configurationSchema.ConfigurationReference(configSchema)
  })).actions(function (self) {
    return {
      openFilterConfig: function openFilterConfig() {
        var session = util.getSession(self); // @ts-ignore
    ...
    return {
      ...
      trackMenuItems: function trackMenuItems() {
        return [].concat(_toConsumableArray(superTrackMenuItems()), [{
          ...
          icon: FilterListIcon__default["default"]
        }]);
      }
    };
  });
...
function stateModelFactory(pluginManager) {
  var stateModel = mobxStateTree.types.model('ICGCFeatureWidget', {
    id: mst.ElementId,
    type: mobxStateTree.types.literal('ICGCFeatureWidget'),
...
var Transcript = /*#__PURE__*/mobxReact.observer(function (props) {
  var id = props.id,
  ...
  return /*#__PURE__*/React__default["default"].createElement(BaseFeatureDetail.BaseCard, {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        // @ts-ignore
        width: util.measureText("".concat(attribute), 12) + 10
...
var icgcFeatureWidgetReactComponent = /*#__PURE__*/mobxReact.observer(ICGCFeatureDetails);

var stateModel = (function (pluginManager) {
  var Filter = mobxStateTree.types.model({
    id: mobxStateTree.types.identifier,
    category: mobxStateTree.types.string,
    type: mobxStateTree.types.string,
    filter: mobxStateTree.types.string
  }).actions(function (self) {
    return {
  ...
  var ColourBy = mobxStateTree.types.model({
    id: mobxStateTree.types.identifier,
    value: mobxStateTree.types.string
  });
  return mobxStateTree.types.model('ICGCFilterWidget', {
    id: mst.ElementId,
    type: mobxStateTree.types.literal('ICGCFilterWidget'),
    target: mobxStateTree.types.safeReference(pluginManager.pluggableConfigSchemaType('track')),
    filters: mobxStateTree.types.array(Filter),
    colourBy: mobxStateTree.types.map(ColourBy)
  }).actions(function (self) {
    return {
...
var Filter = /*#__PURE__*/mobxReact.observer(function (props) {
  var facets = props.facets,
      schema = props.schema,
      filterModel = props.filterModel;

  var _useState = React.useState(filterModel.category ? filterModel.category : facets ? Object.keys(facets)[0] : ''),
      _useState2 = _slicedToArray(_useState, 2),
      category = _useState2[0],
      setCategory = _useState2[1];

  var _useState3 = React.useState(filterModel.filter ? filterModel.filter.replace(/(["]+)/g, '').replace(/([\[])+/g, '').replace(/[\]]+/g, '').split(',') : []),
...
var FilterList = /*#__PURE__*/mobxReact.observer(function (_ref) {
  ...
  var handleClick = function handleClick() {
    // @ts-ignore
    schema.addFilter(uuid.v4(), facets ? Object.keys(facets)[0] : '', // one of the facet categories
...
function ConfigurationEditor(_ref) {
  ...
  var _useState3 = React.useState(model.target.adapter.featureType.value ? model.target.adapter.featureType.value : 'mutations'),
      _useState4 = _slicedToArray(_useState3, 2),
      type = _useState4[0],
  ...
  React.useEffect(function () {
    ...
    for (var filter in filters) {
      for (var prop in filters[filter]) {
        model.addFilter(uuid.v4(), prop, "".concat(filter, "s"), JSON.stringify(filters[filter][prop]['is']));
      }
    }
  }, [model]);
  return /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(UndoIcon__default["default"], null)))), /*#__PURE__*/React__default["default"].createElement(core.Box, null, /*#__PURE__*/React__default["default"].createElement(core.Tabs, {
    value: value,
...
var ReactComponent$1 = /*#__PURE__*/mobxReact.observer(ConfigurationEditor);
...
function f(pluginManager) {
  return mobxStateTree.types.model('ICGCSearchWidget', {
    id: mst.ElementId,
    type: mobxStateTree.types.literal('ICGCSearchWidget')
  })["volatile"](function () {
    return {
      trackData: undefined,
...
var ReactComponent = /*#__PURE__*/mobxReact.observer(Panel);
...
var ICGCAdapter = /*#__PURE__*/function (_BaseFeatureDataAdapt) {
  ...
  function ICGCAdapter(config) {
    ...
    _defineProperty(_assertThisInitialized(_this), "featureCache", new AbortablePromiseCache__default["default"]({
      cache: new LRU__default["default"]({
        maxSize: 200
      }),
      fill: function () {
...
var icgcConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('ICGCAdapter', {
  ...
  featureType: {
    type: 'stringEnum',
    model: /*#__PURE__*/mobxStateTree.types.enumeration('Feature Type', ['mutations', 'occurrences']),
...
//# sourceMappingURL=jbrowse-plugin-icgc.cjs.development.js.map
