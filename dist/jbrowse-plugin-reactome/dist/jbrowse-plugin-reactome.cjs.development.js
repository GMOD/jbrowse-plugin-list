...
var domLoadScript = require('load-script2');
var core = require('@material-ui/core');
var lab = require('@material-ui/lab');
var SearchIcon = require('@material-ui/icons/Search');
var reactWindow = require('react-window');
var mobxStateTree = require('mobx-state-tree');
var ShowChartIcon = require('@material-ui/icons/ShowChart');
...
var domLoadScript__default = /*#__PURE__*/_interopDefaultLegacy(domLoadScript);
var SearchIcon__default = /*#__PURE__*/_interopDefaultLegacy(SearchIcon);
var ShowChartIcon__default = /*#__PURE__*/_interopDefaultLegacy(ShowChartIcon);
    ...
    return _regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return domLoadScript__default["default"]('https://dev.reactome.org/DiagramJs/diagram/diagram.nocache.js');
...
var ReactomeView = /*#__PURE__*/mobxReact.observer(function (_ref) {
  ...
  var _useState = React.useState((_model$pathways = model.pathways) !== null && _model$pathways !== void 0 && _model$pathways.length ? model.pathways.length : 0),
  ...
  }, model.pathways ? /*#__PURE__*/React__default["default"].createElement(reactWindow.FixedSizeList, {
    height: 500,
    width: 300,
    itemSize: 56,
    ...
    value: function configure(pluginManager) {
      if (util.isAbstractMenuManager(pluginManager.rootModel)) {
        pluginManager.rootModel.appendToMenu('Add', {
          label: 'Reactome View',
          icon: ShowChartIcon__default["default"],
...
//# sourceMappingURL=jbrowse-plugin-reactome.cjs.development.js.map
