...
import { Grid, TextField, Box, Typography, makeStyles, ListItem, ListItemText, IconButton } from '@material-ui/core';
    ...
    return _regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return domLoadScript('https://dev.reactome.org/DiagramJs/diagram/diagram.nocache.js');
...
var ReactomeView = /*#__PURE__*/observer(function (_ref) {
  var _model$pathways;

  var model = _ref.model;
  var inputRef = useRef();

  var _useState = useState((_model$pathways = model.pathways) !== null && _model$pathways !== void 0 && _model$pathways.length ? model.pathways.length : 0),
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Grid, {
    ...
    InputProps: {
      endAdornment: /*#__PURE__*/React.createElement(SearchButton, null)
    },
    style: {
      width: 625
    },
  ...
  }, model.message), /*#__PURE__*/React.createElement(Grid, {
    container: true,
    direction: "row",
    justifyContent: "center",
    alignItems: "center",
  ...
  }, model.pathways ? /*#__PURE__*/React.createElement(FixedSizeList, {
    height: 500,
    width: 300,
    itemSize: 56,
    itemCount: pathwayCount,
    className: classes.pathwayDisplay
  }, renderRow) : /*#__PURE__*/React.createElement(Box, {
    className: classes.pathwayDisplay,
    height: 500,
    width: 300
  }, /*#__PURE__*/React.createElement(Typography, {
    align: "center"
  }, "There are no pathways to be displayed.")), /*#__PURE__*/React.createElement("div", {
    id: "diagramHolder"
  }))));
});

var stateModel = /*#__PURE__*/types.model({
...
var ReactomePlugin = /*#__PURE__*/function (_Plugin) {
  ...
  function ReactomePlugin() {
    ...
    _defineProperty(_assertThisInitialized(_this), "name", 'ReactomePlugin');
...
export { ReactomePlugin as default };
